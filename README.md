# EcoLanding FoundationPress

This theme, based on FoundationPress, is built for a simple site that uses Easy Digital Downloads. The rest of the readme is FoundationPress.
